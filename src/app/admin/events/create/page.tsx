...
import { ArrowLeft, Save, Calendar, Globe, MapPin, Link as LinkIcon, Loader2 } from "lucide-react";
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center pb-4 border-b border-gray-200 dark:border-zinc-800">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold font-thai tracking-tight uppercase text-black dark:text-white">New Event</h1>
                </div>
