...
export function Footer() {
    ...
    return (
        <footer className="w-full bg-[#000000] dark:bg-black text-white pt-16 pb-8 font-thai border-t border-transparent dark:border-white/10 transition-colors duration-300">
